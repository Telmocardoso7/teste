<%@ Control Language="C#" AutoEventWireup="true" EnableViewState="true" CodeBehind="EntityDetails.ascx.cs" Inherits="eBankit.UI.Modules.Web.AccountOpening.EntityDetails" %>
<%@ Register TagPrefix="st" TagName="EntityDetailsData" Src="EntityDetailsData.ascx"   %>
        ...
        <asp:Repeater ID="repeaterHoldersContent" runat="server">
            <ItemTemplate>
                <div id='entityData<%# Container.DataItem %>' class="tab">
                    <st:EntityDetailsData ID="entityData" runat="server" />
                </div>
            </ItemTemplate>
        </asp:Repeater>
