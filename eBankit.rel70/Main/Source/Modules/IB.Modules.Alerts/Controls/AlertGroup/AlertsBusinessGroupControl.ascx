<%@ Control Language="C#" AutoEventWireup="true" EnableViewState="true" CodeBehind="AlertsBusinessGroupControl.ascx.cs" Inherits="eBankit.UI.Modules.Web.Alerts.AlertsBusinessGroupControl" %>
