<%@ Control Language="C#" AutoEventWireup="true" EnableViewState="true" CodeBehind="AlertsTransactionGroupControl.ascx.cs" Inherits="eBankit.UI.Modules.Web.Alerts.AlertsTransactionGroupControl" %>
...
<asp:UpdatePanel ID="UpdatePanel" runat="server">
    <ContentTemplate>
        ...
        <asp:Repeater ID="rptAlertsTransaction" runat="server" OnItemDataBound="AlertsDataBound">
            <HeaderTemplate>
