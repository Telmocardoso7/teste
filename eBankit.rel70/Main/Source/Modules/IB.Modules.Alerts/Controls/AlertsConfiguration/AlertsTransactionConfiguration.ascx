<%@ Control Language="C#" AutoEventWireup="true" EnableViewState="true" CodeBehind="AlertsTransactionConfiguration.ascx.cs" Inherits="eBankit.UI.Modules.Web.Alerts.AlertsTransactionConfiguration" %>

<%@ Register TagPrefix="it" TagName="AlertsTransactionGroupControl" Src="../AlertGroup/AlertsTransactionGroupControl.ascx" %>
...
<asp:UpdatePanel runat="server" ID="updatePanelConfiguration" UpdateMode="Conditional" ChildrenAsTriggers="true" RenderMode="Block">
    <ContentTemplate>
        <div class="alert-notifications-container">
            <asp:Repeater ID="rptAlertTransactionGroups" runat="server" OnItemDataBound="OnAlertsDataBound">
                <ItemTemplate>
                    <it:alertstransactiongroupcontrol id="alertsTransactionGroupControl" runat="server" />
                </ItemTemplate>
            </asp:Repeater>
        </div>
