<%@ Control Language="C#" AutoEventWireup="true" EnableViewState="true" CodeBehind="AlertsSecurityConfiguration.ascx.cs" Inherits="eBankit.UI.Modules.Web.Alerts.AlertsSecurityConfiguration" %>

<%@ Register TagPrefix="it" TagName="AlertsSecurityGroupControl" Src="../AlertGroup/AlertsSecurityGroupControl.ascx" %>
...
<asp:UpdatePanel runat="server" ID="updatePanelConfiguration" UpdateMode="Conditional" ChildrenAsTriggers="true" RenderMode="Block">
    <ContentTemplate>
        <div class="alert-notifications-container">
            <asp:Repeater ID="rptAlertSecurityGroups" runat="server" OnItemDataBound="OnAlertsDataBound">
                <ItemTemplate>
                    <it:alertssecuritygroupcontrol id="alertsSecurityGroupControl" runat="server" />
                </ItemTemplate>
            </asp:Repeater>
        </div>
