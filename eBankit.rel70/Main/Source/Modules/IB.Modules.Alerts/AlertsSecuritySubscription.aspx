...
<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/Transaction.Master" CodeBehind="AlertsSecuritySubscription.aspx.cs" Inherits="eBankit.UI.Modules.Web.Alerts.AlertsSecuritySubscription" %>
<%@ Register TagPrefix="it" TagName="AlertsSecurityConfiguration" Src="Controls/AlertsConfiguration/AlertsSecurityConfiguration.ascx" %>
                ...
                <div id="FeaturedContent_TransactionFeaturedContent_UpdatePanel2">
                    ...
                    <hgroup class="title">
                        <h3 class="head head-top">
                            <asp:Literal ID="Literal6" Text="<%$FrontEndResources:AlertsSecuritySubscription,Title%>" runat="server"></asp:Literal></h3>
                    </hgroup>
     ...
     <div class="custom-accounts-panel tab-pane metro sortable-list ui-sortable">
        <div class="headerContainer" id="infoTopMessage" runat="server">
            <div class="metro info-bottom-text col-lg-8 col-max heavyMargin">
                <asp:Label ID="lblInfoMessageSecurity" Text="<%$FrontEndResources:AlertsSecuritySubscription,InfoTopMessage %>" CssClass="infoTopMessage" runat="server"></asp:Label>
                <br />
        ...
        <asp:UpdatePanel ID="updPanel" runat="server">
            <ContentTemplate>
                <asp:Panel ID="configurationPanel" Visible="true" runat="server">
                    ...
                    <it:AlertsSecurityConfiguration EnableViewState="true" ID="alertsSecurityConfigurationControl" runat="server" />
                </asp:Panel>
            </ContentTemplate>
        </asp:UpdatePanel>
    </div>
