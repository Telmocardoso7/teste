...
REM SHELL PATHS
SET shellPathSource=%cd%\CSP\CustomerServicesPlatform.FO\CustomerServicesPlatform.FO.csproj
SET shellPathTarget=%cd%\..\..\Ebankit.rel70.NetCore\FrontOffice
...
DOTNET publish "%shellPathSource%" --output "%shellPathTarget%" -c FO
GOTO End
