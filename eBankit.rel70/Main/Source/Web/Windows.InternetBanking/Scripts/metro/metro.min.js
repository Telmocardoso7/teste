...
$(function () { $(window).on("resize", function () { if (METRO_DIALOG) { var c = ($(window).height() - METRO_DIALOG.outerHeight()) / 2, a = ($(window).width() - METRO_DIALOG.outerWidth()) / 2; METRO_DIALOG.css({ top: c, left: a }) } }) }); (function (c) {
    c.Metro.currentLocale = "en"; c.Metro.currentLocale = void 0 != METRO_LOCALE ? METRO_LOCALE : "en"; c.Metro.Locale = {
        en: { months: "January February March April May June July August September October November December Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), days: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday Su Mo Tu We Th Fr Sa".split(" "), buttons: "Today Clear Cancel Help Prior Next Finish".split(" ") }, pt: { months: "Janeiro Fevereiro Marco Abril Maio Junho Julho Agosto Setembro Outubro Novembro Dezembro Jan Fev Mar Abr Mai Jun Jul Ago Set Out Nov Dez".split(" "), days: "Domingo Segunda Terça Quarta Quinta Sexta Sábado Do Sg Te Qa Qi Se Sa".split(" "), buttons: "Hoje Limpar Cancelar Ajuda Anterior Seguinte Fim".split(" ") }, fr: {
            ...
            days: "Sunday Lundi Mardi Mercredi Jeudi Vendredi Samedi Sn Ln Md Mc Ju Vn Sm".split(" "), buttons: "Aujourd Effacer Cancel Help Prior Next Finish".split(" ")
        }, ua: {
...
(function (c) {
    ...
    c.widget("metro.dropdown", {
        version: "1.0.0", options: { effect: "slide" }, _create: function () {
            var a = this, b = this.element, d = this.name, e = this.element.parent().children(".dropdown-toggle"); void 0 != b.data("effect") && (this.options.effect = b.data("effect")); e.on("click." + d, function (d) {
...
(function (c) {
    c.widget("metro.inputTransform", {
        version: "1.0.0", options: { transformType: "text" }, _create: function () {
            var a = this.element, b; if (!a.parent().hasClass("input-control")) {
                b = a.get(0).tagName.toLowerCase(); "textarea" == b ? this.options.transformType = "textarea" : "select" == b ? this.options.transformType = "select" : void 0 != a.data("transformType") ? this.options.transformType = a.data("transformType") : this.options.transformType = a.attr("type"); a = void 0; switch (this.options.transformType) {
                    case "password": a = this._createInputPassword();
                        break; case "file": a = this._createInputFile(); break; case "checkbox": a = this._createInputCheckbox(); break; case "radio": a = this._createInputRadio(); break; case "switch": a = this._createInputSwitch(); break; case "select": a = this._createInputSelect(); break; case "textarea": a = this._createInputTextarea(); break; case "search": a = this._createInputSearch(); break; case "email": a = this._createInputEmail(); break; case "tel": a = this._createInputTel(); break; default: a = this._createInputText()
                } a.inputControl()
            }
        }, _createInputTextarea: function () {
            var a =
            this.element, b = c("<div/>").addClass("input-control").addClass("textarea"), d = a.clone(!0); a.parent(); d.appendTo(b); b.insertBefore(a); a.remove(); return b
        }, _createInputSelect: function () { var a = this.element, b = c("<div/>").addClass("input-control").addClass("select"), d = a.clone(!0); a.parent(); d.val(a.val()).appendTo(b); b.insertBefore(a); a.remove(); return b }, _createInputSwitch: function () {
            var a = this.element, b = c("<div/>").addClass("input-control").addClass("switch"), d = c("<label/>"), e = c("<span/>").addClass("check"),
            f = a.clone(!0); a.parent(); var g = c("<span/>").addClass("caption").html(void 0 != a.data("caption") ? a.data("caption") : ""); d.appendTo(b); f.appendTo(d); e.appendTo(d); g.appendTo(d); b.insertBefore(a); a.remove(); return b
        }, _createInputCheckbox: function () {
            var a = this.element, b = c("<div/>").addClass("input-control").addClass("checkbox"), d = c("<label/>"), e = c("<span/>").addClass("check"), f = a.clone(!0); a.parent(); var g = c("<span/>").addClass("caption").html(void 0 != a.data("caption") ? a.data("caption") : ""); d.appendTo(b);
            f.appendTo(d); e.appendTo(d); g.appendTo(d); b.insertBefore(a); a.remove(); return b
            ...
            var a = this.element, b = c("<div/>").addClass("input-control").addClass("text"),
            d = c("<button/>").addClass("btn-search"), e = a.clone(!0); a.parent(); e.appendTo(b); d.appendTo(b); b.insertBefore(a); a.remove(); return b
        }, _createInputTel: function () { var a = this.element, b = c("<div/>").addClass("input-control").addClass("tel"), d = c("<button/>").addClass("btn-clear"), e = a.clone(!0); a.parent(); e.appendTo(b); d.appendTo(b); b.insertBefore(a); a.remove(); return b }, _createInputEmail: function () {
            var a = this.element, b = c("<div/>").addClass("input-control").addClass("email"), d = c("<button/>").addClass("btn-clear"),
            e = a.clone(!0); a.parent(); e.appendTo(b); d.appendTo(b); b.insertBefore(a); a.remove(); return b
        }, _createInputText: function () { var a = this.element, b = c("<div/>").addClass("input-control").addClass("text"), d = c("<button/>").addClass("btn-clear"), e = a.clone(!0); a.parent(); e.appendTo(b); d.appendTo(b); b.insertBefore(a); a.remove(); return b }, _createInputPassword: function () {
            var a = this.element, b = c("<div/>").addClass("input-control").addClass("password"), d = c("<button/>").addClass("btn-reveal"), e = a.clone(!0); a.parent();
            e.appendTo(b); d.appendTo(b); b.insertBefore(a); a.remove(); return b
        }, _createInputFile: function () { var a = this.element, b = c("<div/>").addClass("input-control").addClass("file"), d = c("<button/>").addClass("btn-file"), e = a.clone(!0); a.parent(); e.appendTo(b); d.appendTo(b); b.insertBefore(a); a.remove(); return b }, _destroy: function () { }, _setOption: function (a, b) { this._super("_setOption", a, b) }
    })
})(jQuery); (function (c) {
    ...
    var a = !1, b = []; c.Notify = function (d) {
        d = c.extend({ icon: "", caption: "", content: "", shadow: !0, width: "auto", height: "auto", style: !1, position: "right", timeout: 5E3 }, d); var e = a || c("<div/>").addClass("metro notify-container").appendTo("body"); a = e; if ("" != d.content && void 0 != d.content) {
            var f; f = c("<div/>").addClass("notify"); d.shadow && f.addClass("shadow"); d.style && void 0 != d.style.background && f.css("background-color", d.style.background); d.style && void 0 != d.style.color && f.css("color", d.style.color); "" != d.caption &&
    ...
    }; c.Notify.show = function (a, b) { c.Notify({ content: a, caption: b }) }; c.Notify.close = function (a) {
        if (void 0 == a) return !1; a.fadeOut("slow", function () {
            c(this).remove();
...
})(jQuery); (function (c) {// c.Metro.initDatepickers = function (a) { void 0 != a ? c(a).find("[data-role=datepicker]").datepicker() : c("[data-role=datepicker]").datepicker() };c.Metro.initDatepickers(a);
