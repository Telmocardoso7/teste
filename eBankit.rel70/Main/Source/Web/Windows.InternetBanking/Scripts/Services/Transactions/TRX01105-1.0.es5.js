...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var $params = { debug: false, rules: {}, messages: {}, success: function success(label) {
...
customPhoneValidation = function () {
    var phoneInputElem = $('[id$=PhoneTextBoxControl_txField]');
...
customEmailValidation = function () {
    var emailInputElem = $('[id$=TextBoxControlEmail_txField]');
