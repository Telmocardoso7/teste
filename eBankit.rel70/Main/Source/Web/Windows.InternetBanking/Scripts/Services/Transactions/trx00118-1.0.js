eBankit.Presentation.TRX00118 = {};

eBankit.Presentation.TRX00118.ValidateCustom = function () {
    var ret = true;
    ...
    if (ddlAmount.find('option:selected').val() === '-1') {
        ...
        if (ddlAmount.val() === hdnOption.val()) {
            ret = eBankit.Presentation.TRX00118.ValidateAmount();
        }
    }
    return ret;
};
...
eBankit.Presentation.TRX00118.ValidateAmount = function () {
    var ret = true;
