eBankit.Presentation.TRX01120 = function () {
...
Sys.WebForms.PageRequestManager.getInstance().add_endRequest(eBankit.Presentation.TRX01120);


$(document).ready(function () {
    eBankit.Presentation.TRX01120();

    $('.col-lg-8.col-max.panel-header.panel-header-3').keypress(function (e) {
        if (e.keyCode === 32 || e.keyCode === 13) {
            e.preventDefault();
            $(this).click();
        }
