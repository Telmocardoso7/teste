$(document).ready(function () {
    configMultiselect();
    $("#MainContent_TransactionMainContent_flwUserData_ddlAccount").attr("tabindex", "-1");
    $("#MainContent_TransactionMainContent_flwUserData_ddlTransactions").attr("tabindex", "-1");
