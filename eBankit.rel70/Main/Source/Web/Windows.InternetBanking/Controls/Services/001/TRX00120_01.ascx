<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TRX00120_01.ascx.cs" Inherits="TRX00120_01" %>
...
<div id="divContent" runat="server">
    <asp:UpdatePanel ID="updPanel" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <div id="divContainer" runat="server" class="transaction-content servicePaymentForm">
                <it:PaymentEntityControl ID="phonePaymentEntitiesList" runat="server" AllowOtherEntities="true" SelectDefaultEntity="false" InServiceType="StatePayment" />
                    ...
                    <div>
                        ...
                        <div id="divData" runat="server">
                            ...
                            <it:CurrencyTextBoxControlAuto ID="txtAmount" IsRequired="true" ValidateWithAccountBalance="true"
                                ShowCurrency="true" AllowValuesUnderOne="true" ShowLimitValidation="true" TransactionId="137" AssetImpactTypeId="2"
                                ...
                                OnKeyUp="eBankit.Presentation.TRX00120.ValidateAmount();" />                            
                        </div>
                    </div>
    ...
    <script type="text/javascript" src="<%= eBankit.Common.Sites.Utils.GetCacheVersion("/Scripts/Services/Transactions/TRX00120-1.0.js", eBankit.Common.Sites.Utils.CacheVersionKey.JScript) %>"></script>
    <link rel="stylesheet" type="text/css" href="<%= eBankit.Common.Sites.Utils.GetCacheVersion("TRX00120-1.0.css".ResolveCssUrl("services/transactions"), eBankit.Common.Sites.Utils.CacheVersionKey.CStyleSheet) %>" />
</div>
