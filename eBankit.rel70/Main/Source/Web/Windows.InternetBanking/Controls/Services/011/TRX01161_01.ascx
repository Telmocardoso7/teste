<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TRX01161_01.ascx.cs" Inherits="TRX01161_01" %>
...
<div id="divContent" runat="server" class="transaction-content">
    <asp:UpdatePanel ID="updContent" runat="server" UpdateMode="Always">
        <ContentTemplate>
                                ...
                                <ItemTemplate>
                                    <div id="divImageContainer" runat="server" class="image-container-item" onclick="selectImage(this);">
                                        <div id="divImageContainerImage" runat="server" class="image-container-image">
                                            ...
                                            <asp:Image ID="imageSecurity" runat="server" Height="136" Width="136" ViewStateMode="Disabled"/>   
                                        </div>
            ...
            <it:FlowInnerContainer ID="flwSecurityImageCaption" Title="<%$FrontEndResources:TRX01160,TitleCaptionContainer %>" CustomCssClass="col-max bs-reduced bs-head-metro bs-reduced-transaction" runat="server">
                <div>
                    <it:TextBoxControl_v2 ID="txtSelectedImageCaption" IsRequired="True" MaxLength="120" MinLength="3" Label="<%$FrontEndResources:TRX01160,txtSelectedImage%>" ValidationMinLengthMessage="<%$FrontEndResources:TRX01160,txtSelectedImageCaptionInvalid%>" runat="server" />
                </div>
            </it:FlowInnerContainer>
    ...
    <script type="text/javascript" src="<%= eBankit.Common.Sites.Utils.GetCacheVersion("TRX01161-1.0.js".ResolveJsUrl("Services/Transactions"), eBankit.Common.Sites.Utils.CacheVersionKey.JScript) %>"></script>
    <link rel="stylesheet" type="text/css" href="<%= eBankit.Common.Sites.Utils.GetCacheVersion("TRX01161-1.0.css".ResolveCssUrl("services/transactions"), eBankit.Common.Sites.Utils.CacheVersionKey.CStyleSheet) %>" />
</div>