<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TRX00213_01.ascx.cs" Inherits="TRX00213_01" %>
...
<div id="divTransaction" class="transaction-content" style="margin-bottom: 10px;" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="<%= eBankit.Common.Sites.Utils.GetCacheVersion("TRX00213-1.0.css".ResolveCssUrl("services/transactions"), eBankit.Common.Sites.Utils.CacheVersionKey.CStyleSheet) %>" />
</div>
