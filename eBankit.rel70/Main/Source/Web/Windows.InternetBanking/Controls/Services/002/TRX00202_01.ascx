<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TRX00202_01.ascx.cs" Inherits="TRX00202_01" %>
...
<div id="divTransaction" class="transaction-content" style="margin-bottom: 10px;" runat="server">
            ...
            <asp:Panel ID="pnControls" CssClass="clearPadding" runat="server">
                <it:FlowInnerContainer ID="flwContainer" CustomCssClass="col-max bs-reduced bs-head-metro bs-reduced-transaction" runat="server">
                    <div>
                        ...
                        <it:FlowLabel_v3 ID="lblType" Label="<%$FrontEndResources:TRX00202,lblType%>" runat="server"/>
                        <it:FlowLabel_v3 ID="lblSituation" Label="<%$FrontEndResources:TRX00202,lblSituation%>" runat="server" />
                        <it:FlowLabel_v3 ID="lblSituationDate" Label="<%$FrontEndResources:TRX00202,lblSituationDate%>" runat="server" />
                        ...
                        <it:FlowLabel_v3 ID="lblUsageCount" Label="<%$FrontEndResources:TRX00202,lblUsageCount%>" runat="server" />
                        <it:FlowLabel_v3 ID="lblLastUseDate" Label="<%$FrontEndResources:TRX00202,lblLastUseDate%>" runat="server" />
                ...
                <it:FlowInnerContainer ID="flwContainerCurrentAccount" CustomCssClass="col-max bs-reduced bs-head-metro bs-reduced-transaction" Title="<%$FrontEndResources:TRX00301,litCurrentCharacteristics%>" runat="server">
                    <div>
                        <it:FlowLabel_v3 ID="lblCurrentAccountNumber" Label="<%$FrontEndResources:TRX00202,lblCurrentAccountNumber%>" runat="server" />
                    </div>
                </it:FlowInnerContainer>
                ...
                <it:FlowInnerContainer ID="flwContainerBalance" CustomCssClass="col-max bs-reduced bs-head-metro bs-reduced-transaction" Title="<%$FrontEndResources:TRX00301,litBalanceTitle%>" runat="server">
                    <div>
    ...
    <link rel="stylesheet" type="text/css" href="<%= eBankit.Common.Sites.Utils.GetCacheVersion("TRX00202-1.0.css".ResolveCssUrl("services/transactions"), eBankit.Common.Sites.Utils.CacheVersionKey.CStyleSheet) %>" />
</div>
