<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataListControl.ascx.cs" Inherits="DataListControl" %>
...
<div id="divDataList" runat="server">
    <div class="transaction-content" style="margin-bottom: 10px">
                ...
                <div class="metro" style="margin-left: 0px;">
                    <div class="panel" data-role="panel" id="divTesteaver" style="border: none; margin-bottom: 0px; background-color: rgb(247, 246, 246);">
                        ...
                        <div class="col-lg-8 col-max panel-content panel-search" style="background-color: rgb(247, 246, 246);">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <it:DropDownListControl_v2 ID="ddlMovType" Visible="false" Label="<%$FrontEndResources:DATALIST,MovType%>" runat="server" CssClass="field field_v2 field-full" />
                            </div>
        ...
        <asp:UpdatePanel ID="updPanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="table-grid-border col-lg-8 col-max">
                    ...
                    <asp:HiddenField ID="hdnCurrentAccount" Value="0" runat="server" />
        ...
        <iframe id="iframeControlDocument" name="iframeControlDocument" src="/DigitalDocument.aspx" height="0" width="0" style="border: 0;" role="presentation" aria-label="iframeControlDocument"></iframe>
    </div>
</div>
