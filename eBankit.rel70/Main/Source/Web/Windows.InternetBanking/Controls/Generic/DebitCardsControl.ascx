<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DebitCardsControl.ascx.cs" Inherits="DebitCardsControl" %>
                ...
                <div>
                    <div class="slickSlider">
                        <asp:Repeater ID="rptCreditCards" runat="server" OnItemDataBound="rptCreditCards_ItemDataBound">
                            <ItemTemplate>
                                <div id="divCard" runat="server" onkeydown="eBankit.Presentation.AccountsControl.DebitCardKeydownHandler(this, event);" onkeyup="eBankit.Presentation.AccountsControl.DebitCardKeyupHandler(this, event);">
...
<asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Always" runat="server">
    <ContentTemplate>
        <it:TabSelectorControl
            ...
            visible="false"
            runat="server"
            titleOperations="<%$FrontEndResources:TRX00213,titleOperations%>"
...
<script type="text/javascript">
    ...
    eBankit.Presentation.AccountsControl.DebitCardKeydownHandler = function (elem, event) {
        if (event.keyCode === 32) {
    ...
    eBankit.Presentation.AccountsControl.DebitCardKeyupHandler = function (elem, event) {
        if (event.keyCode === 32) {
            event.preventDefault();
            $(elem).click();
        }
