<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/Transaction.Master" CodeBehind="GroupEditSignature.aspx.cs" Inherits="eBankit.UI.Web.InternetBanking.Controls.Contract.GroupEditSignature" %>
...
<asp:Content ID="FeaturedContent" ContentPlaceHolderID="TransactionFeaturedContent" runat="server">
    ...
    <style>
        #divCombinationOne > .row > .field.break > .label-wrapper > label, #divCombinationTwo >
        .row > .field.break > .label-wrapper > label, #divCombinationThree > .row > .field.break > .label-wrapper > label {
            width: 77%;
    ...
    <script>
        $(document).ready(function () {
            ...
            $("button.ddlAccountTest").eq(0).attr("aria-label", $("#MainContent_TransactionMainContent_flwImpact_ddlAccount").attr("aria-label"));
            $("button.ddlAccountTest").eq(1).attr("aria-label", $("#MainContent_TransactionMainContent_flwImpact_ddlTransactions").attr("aria-label"));
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-max divInformational" style="margin: 20px auto">
        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 col-max bs-reduced metro" style="margin: 20px auto">
            <asp:Literal ID="Literal1" Text="<%$FrontEndResources:GroupEditSgnature,Informational%>" runat="server"></asp:Literal>
        </div>
    </div>
