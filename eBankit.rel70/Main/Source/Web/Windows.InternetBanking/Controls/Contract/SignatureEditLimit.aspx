<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/Transaction.Master" CodeBehind="SignatureEditLimit.aspx.cs" Inherits="eBankit.UI.Web.InternetBanking.Controls.Contract.SignatureEditLimit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="TransactionFeaturedContent" runat="server">
    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 col-max bs-reduced metro" style="margin: 20px auto">
        <h3 class="head head-top">
            <asp:Literal ID="litTitle" Text="<%$FrontEndResources:SignatureEditRule,Title%>" runat="server"></asp:Literal>
        </h3>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-max divInformational" style="margin: 20px auto">
        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 col-max bs-reduced metro" style="margin: 20px auto">
            <asp:Literal ID="Literal3" Text="<%$FrontEndResources:SignatureEditRule,Informational%>" runat="server"></asp:Literal>
        </div>
    </div>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="TransactionMainContent" runat="server">
    ...
    <div id="divMainContent" runat="server" class="col-lg-8 col-max grid-contract-items grid-no-pagination">
        <section class="muc costumer-contract-details">
            <div class="ebankit-accordion-list col-xs-12 col-sm-12 col-md-10 col-lg-8 col-max col-max bs-reduced bs-head-metro muc-no-border-top displayInlineBlock" id="divContractDetails" runat="server">
                <it:FlowInnerContainer ID="flwUserData" Title="<%$FrontEndResources:GroupEditRule,SubTitle%>" CustomCssClass="col-max bs-reduced bs-head-metro bs-reduced-transaction" runat="server">
                    <div class="container">
                        <div class="col-xs-12">
                            <div class="col-xs-3 multiselect-label-component">
                                <asp:Label class="img-info" runat="server" ID="lblAccId" Text="<%$FrontEndResources:GroupEditRule,ddlAccount%>"></asp:Label>
                            </div>
                            <div class="col-xs-6" id="divMultiSelectAccount">
                                <asp:ListBox TabIndex="-1" runat="server" ID="ddlAccount" CssClass="ddlAccountTest" SelectionMode="Multiple" multiple></asp:ListBox>
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-3 multiselect-label-component">
                                <asp:Label runat="server" ID="Label1" Text="<%$FrontEndResources:GroupEditRule,ddlChannel%>"></asp:Label>
                            </div>
                            <div class="col-xs-6">
                                <it:DropDownListControl_v2 ID="ddlChannel" ShowLabel="false" Label="<%$FrontEndResources:GroupEditRule,ddlChannel%>" runat="server" IsRequired="True" AutoPostBack="true" />
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div class="col-xs-3 multiselect-label-component">
                            ...
                            <div class="col-xs-6" id="divMultiSelectTransactions">
                                <asp:ListBox TabIndex="-1" runat="server" ID="ddlTransactions" CssClass="ddlAccountTest" SelectionMode="Multiple" multiple></asp:ListBox>
                            </div>
                        </div>
                        <div class="col-xs-12" id="divLimitTypes" runat="server">
                            <div class="col-xs-3 multiselect-label-component">
                                <asp:Label runat="server" ID="Label3" Text="<%$FrontEndResources:GroupEditRule,ddlLimitType%>"></asp:Label>
                            </div>
                            <div class="col-xs-6">
                        ...
                        <div id="divLimits" runat="server">
                            <div id="divAmount" runat="server">
                                <div class="col-xs-12">
                                    <div class="col-xs-3 multiselect-label-component">
                                        <asp:Label runat="server" ID="Label4" Text="<%$FrontEndResources:GroupEditRule,txtAmount%>"></asp:Label>
                                    </div>

                                    <div class="col-xs-7">
                                        <div class="col-xs-10 padding-left-initial txtAmount-width">
                                            <it:CurrencyTextBoxControlAuto ID="txtAmount" IsRequired="true"
                                            ShowLabel="false" Label="<%$FrontEndResources:GroupEditRule,txtAmount%>" ValidateWithAccountBalance="true"
                            ...
                            <div class="col-xs-12" id="divAmountPerTransaciotn" runat="server">
                                <div class="col-xs-3 multiselect-label-component">
                                    <asp:Label runat="server" ID="Label6" Text="<%$FrontEndResources:GroupEditRule,txtAmountPerTransaction%>"></asp:Label>
                                </div>
                                <div class="col-xs-6 heightNumber">
                                    <it:TextBoxControl_v2 ShowLabel="false" Label="<%$FrontEndResources:GroupEditRule,txtAmountPerTransaction%>" ID="txtAmountPerTransaction" autocomplete="off" IsRequired="true" runat="server" Style="min-height: 38px !important;" />
                            ...
                            <div class="col-xs-12">
                                <div class="col-xs-3 multiselect-label-component">
                                    <asp:Label runat="server" ID="Label5" Text="<%$FrontEndResources:GroupEditRule,ddlPeriodicity%>"></asp:Label>
                                </div>
                                <div class="col-xs-6">
    ...
    <script type="text/javascript" src="<%= eBankit.Common.Sites.Utils.GetCacheVersion("~/Scripts/Services/MUC/SignatureEditLimit.js", eBankit.Common.Sites.Utils.CacheVersionKey.JScript) %>"></script>
