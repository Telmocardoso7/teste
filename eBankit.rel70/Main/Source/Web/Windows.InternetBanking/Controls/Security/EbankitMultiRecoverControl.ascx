<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EbankitMultiRecoverControl.ascx.cs" Inherits="eBankit.UI.Web.InternetBanking.EbankitMultiRecoverControl" %>
...
<div class="recover-form" style="padding-bottom: 20px;">
	...
	<asp:Panel ID="pnStepInit" class="recover-panel" runat="server">
		<div class="panel-login-inputs">
				...
				<it:TextBoxControl_v2 ID="txtAlias" ShowLabel="false" TextMode="SingleLine" ShowRequired="false" IsRequired="true" Label="<%$FrontEndResources:Recover,Alias %>" runat="server" Watermark="<%$FrontEndResources:Recover,AliasWatermark %>" />
