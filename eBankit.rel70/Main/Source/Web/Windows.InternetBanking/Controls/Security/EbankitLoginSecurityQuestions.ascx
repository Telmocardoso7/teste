<%@ Control Language="C#" AutoEventWireup="true" EnableViewState="true"  ViewStateMode="Enabled" CodeBehind="EbankitLoginSecurityQuestions.ascx.cs" Inherits="eBankit.UI.Web.InternetBanking.EbankitLoginSecurityQuestions" %>
