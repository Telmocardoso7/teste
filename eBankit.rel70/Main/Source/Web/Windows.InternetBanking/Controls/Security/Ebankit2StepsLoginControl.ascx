<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ebankit2StepsLoginControl.ascx.cs" Inherits="Ebankit2StepsLoginControl" %>
...
<div id="loginContainer" class="login-container" style="padding-bottom: 20px;" runat="server">
    ...
    <div id="divPasswordRecovery" class="ebankit-pointer-text clearPadding forgetPwdContainer" data-toggle="collapse" data-target="#collapseForgetPwd" tabindex="0" role="link">
        <div>
...
<script type="text/javascript">
    ...
    fingerprintReport();
    $("div[id*='divPasswordRecovery']").on("keypress", function (e) {
        if (e.keyCode === 13) {
            $(this).click();
        }
    });
