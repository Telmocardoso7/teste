<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LandingSurveyControl.ascx.cs" Inherits="eBankit.UI.Web.InternetBanking.Controls.Landingpage.LandingSurveyControl" %>
                    ...
                    <div id="divStars" class="divStars" runat="server">
                        <div id="divStarsInfo">
                            ...
                            <div id="divComments" class="commentsText" runat="server">
                                <asp:Label ID="lblCommentsInfo" runat="server" Text="<%$FrontEndResources:LandingSurvey,CommentsInfo%>" CssClass="commentsInfo"></asp:Label>
                                <asp:TextBox ID="txtStarsComments" ToolTip="<%$FrontEndResources:LandingSurvey,CommentsInfo%>" runat="server" TextMode="MultiLine" MaxLength="250" class="commentsTextArea"></asp:TextBox>
                            </div>
                            <div id="divStarsBtnAll" class="divBtnAll">
                                ...
                                <div id="divStarsBtnSubmit" class="divBtnSubmit">
                                    <asp:LinkButton ID="btnStarsSubmit" runat="server" ToolTip="<%$FrontEndResources:LandingSurvey,btnSubmit%>" CssClass="btn-submit">
                                        <asp:Literal ID="litBtnSubmit" Text="<%$FrontEndResources:LandingSurvey,btnSubmit%>" runat="server"></asp:Literal>
                                    </asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="divThumbsUpDown" class="divThumbsUpDown" runat="server">
                        <div id="divdivThumbsUpDownInfo">
                            ...
                            <div id="divThumbsComments" class="commentsText" runat="server">
                                <asp:Label ID="lblThumbsComments" runat="server" Text="<%$FrontEndResources:LandingSurvey,CommentsInfo%>" CssClass="commentsInfo"></asp:Label>
                                <asp:TextBox ID="txtThumbsComments" ToolTip="<%$FrontEndResources:LandingSurvey,CommentsInfo%>" runat="server" TextMode="MultiLine" MaxLength="250" class="commentsTextArea"></asp:TextBox>
                            </div>
                            <div id="divThumbsBtnAll" class="divBtnAll">
                                ...
                                <div id="divThumbsBtnSubmit" class="divBtnSubmit">
                                    <asp:LinkButton ID="btnSubmitThumbs" runat="server" ToolTip="<%$FrontEndResources:LandingSurvey,btnSubmit%>" CssClass="btn-submit">
                                        <asp:Literal ID="litSubmitThumbs" Text="<%$FrontEndResources:LandingSurvey,btnSubmit%>" runat="server"></asp:Literal>
                                    </asp:LinkButton>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 col-max no-padding">
        <div id="divMessageSuccess" runat="server" style="display: none;" class="divMessageSuccess">
            ...
            <div id="divInfoSuccess" class="divInfoSuccess">
                <asp:Label ID="lblInfoSuccess" Text="<%$FrontEndResources:LandingSurvey,InfoSuccess%>" runat="server"></asp:Label>
            </div>
        </div>
        <div id="divMessageError" runat="server" style="display: none;" class="divMessageError">
            ...
            <div id="divInfoError" class="divInfoError">
                <asp:Label ID="lblInfoError" Text="<%$FrontEndResources:LandingSurvey,InfoError%>" runat="server"></asp:Label>
            </div>
        </div>
    </div>
</div>
