<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/Transaction.Master" CodeBehind="LandingPageCP.aspx.cs" Inherits="eBankit.UI.Web.InternetBanking.Security.Transactions.DashboardTemplates.LandingPageCP" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="TransactionMainContent">
    ...
    <div class="clearBoth"></div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-max no-padding">
